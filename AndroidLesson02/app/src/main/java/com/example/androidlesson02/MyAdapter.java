...
public class MyAdapter extends RecyclerView.Adapter<MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.getSurnameView().setText(contact.getSurname());
        holder.getPhoneView().setText(contact.getPhone());
        holder.getEmailView().setText(contact.getEmail());
    }
